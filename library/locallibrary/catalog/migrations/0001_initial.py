# Generated by Django 4.2.13 on 2024-06-11 20:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 characters <a href="www.isbn-internation.org/content/what-isbn">ISBN number</a>', max_length=13, unique=True, verbose_name='ISBN')),
                ('cover', models.ImageField(blank=True, max_length=200, null=True, upload_to='media')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter natural language e.g. English, Spanish etc', max_length=200, unique=True)),
            ],
        ),
